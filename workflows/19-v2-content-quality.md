...
Before downstream V2 research, outline, prewriting, final copy, image, commit, deploy, or publishing work begins, the cluster must have passing Step 0A through Step 8 contracts from `workflows/13-cluster-strategy.md`, ending with Step 8 SEO Content Brief.
