...
Before `seo-agent v2 prepare-page` or any V2 research work begins, the cluster must have a passing Step 0A Foundation gate, the selected page must have a passing Step 0B Page Scope Contract, the selected page must have a passing Step 1 Page Job Contract, the selected page must have a passing Step 2 Search Intent Contract, the selected page must have a passing Step 3 Page Format Contract, the selected page must have a passing Step 4 Next Action Contract, and the selected page must have a passing Step 5 SERP Competitor Analysis from `workflows/13-cluster-strategy.md`.
