...
Before downstream V2 research, prewriting, final copy, image, commit, deploy, or publishing work begins, the cluster must have passing Step 0A through Step 7 contracts from `workflows/13-cluster-strategy.md`, ending with Step 7 Unique Angle And Information Gain.
