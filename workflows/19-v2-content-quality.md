...
Before downstream V2 research, prewriting, final copy, image, commit, deploy, or publishing work begins, the cluster must have a passing Step 0A Foundation gate, the selected page must have a passing Step 0B Page Scope Contract, the selected page must have a passing Step 1 Page Job Contract, the selected page must have a passing Step 2 Search Intent Contract, the selected page must have a passing Step 3 Page Format Contract, the selected page must have a passing Step 4 Next Action Contract, the selected page must have a passing Step 5 SERP Competitor Analysis, and the selected page must have a passing Step 6 Topic Research Bank from `workflows/13-cluster-strategy.md`.
